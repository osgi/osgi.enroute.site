...
However, you now have the responsibility to unregister this service in your deactivate. If you do not clean up this service then your component might be decativated while your service still floats around. Your service is unmanaged. (Although when the bundle is stopped it will be cleaned up.)
