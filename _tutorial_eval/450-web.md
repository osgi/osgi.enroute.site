...
In the `index.html` file we are using [_macros_][Macros] and/or properties. We therefore need to 
...
You should now build the bundle:
...
What we get is a list of active OSGi enRoute applications. 


## Index

If you go to the root of the webserver you get an empty page. It is possible
to get the application listed here. For this, we need to add some metadata
